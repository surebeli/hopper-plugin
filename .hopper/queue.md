...
| T-PLUGIN-09 | spec-write | done-screencast-deferred | T-PLUGIN-08a, T-PLUGIN-08b | normal | PASS materials (no-screencast variant per user 2026-05-20): docs/release/PASS-RATIONALE.md (5-criteria self-assessment) + docs/release/INSTALL-MATRIX.md (4-host install patterns) + scripts/cross-host-verify.sh (structural equivalence proof, all PASS) + root README refresh. Screencast itself deferred as TODO. |
