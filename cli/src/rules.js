...
\`HOPPER_DEFAULT_REASONING\` · \`HOPPER_OPENCODE_VARIANT\` · \`HOPPER_DISPATCH_TIMEOUT_MS\` · \`HOPPER_IDLE_TIMEOUT_MS\` · \`HOPPER_VENDOR_CWD\` · \`HOPPER_GROK_EFFORT\` · \`HOPPER_GROK_PERMISSION_MODE\` · \`HOPPER_CLAUDE_PERMISSION_MODE\` · \`HOPPER_CLAUDE_BARE\` · \`HOPPER_CODEX_ISOLATE\` · \`HOPPER_CODEX_HOME\` · \`HOPPER_CODEX_EXTRA_CONFIG\`
