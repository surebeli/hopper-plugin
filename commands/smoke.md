...
Expected output starts with `hopper standalone (CLI v0.17.0)` (or current version). If the binary runs and exits 0, the Claude Code plugin host adapter is functional (Tier B verified).
