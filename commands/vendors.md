...
The dispatcher will print its own version banner and the registered adapter list. As of v0.15.0, 8 functional vendors are registered: codex, kimi, opencode, copilot, agy, grok, mimo, claude.
