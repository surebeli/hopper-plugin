---
description: List registered vendor adapters (codex, kimi, opencode, copilot, agy, grok).
allowed-tools: Bash
---
...
The dispatcher will print its own version banner and the registered adapter list. As of v0.6.1-phase-6c, 6 functional vendors are registered: codex, kimi, opencode, copilot, agy, grok.
