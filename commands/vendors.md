...
The dispatcher will print its own version banner and the registered adapter list. As of v0.4.0-phase-3 (spec v2.0.3), 5 functional vendors are registered: codex, kimi, opencode, copilot, agy.
